        ...
        <div className="p-6">
          ...
          <nav className="space-y-1">
            ...
            <div className="px-4 py-2 mt-4">
              <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Finance</p>
            </div>
            <SidebarItem to="/financial" icon={<Wallet size={18} />} label="Dashboard Financier" />
            <SidebarItem to="/installments" icon={<CreditCard size={18} />} label="Traites Véhicules" />
            <SidebarItem to="/expenses" icon={<Receipt size={18} />} label="Charges Agence" />
            <SidebarItem to="/claims" icon={<ShieldAlert size={18} />} label="Sinistres & Remb." />
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden fixed inset-0 bg-[#111827] z-[55] pt-20 px-6">
            <nav className="space-y-1">
              ...
              <SidebarItem to="/financial" icon={<Wallet size={18} />} label="Dashboard Financier" onClick={() => setIsMobileMenuOpen(false)} />
              <SidebarItem to="/installments" icon={<CreditCard size={18} />} label="Traites Véhicules" onClick={() => setIsMobileMenuOpen(false)} />
              <SidebarItem to="/expenses" icon={<Receipt size={18} />} label="Charges Agence" onClick={() => setIsMobileMenuOpen(false)} />
              <SidebarItem to="/claims" icon={<ShieldAlert size={18} />} label="Sinistres & Remb." onClick={() => setIsMobileMenuOpen(false)} />
      ...
      <HashRouter>
        <Routes>
          ...
          <Route path="/installments" element={
            <ProtectedRoute>
              <MainLayout><Installments /></MainLayout>
            </ProtectedRoute>
          } />
          ...
          <Route path="/claims" element={
            <ProtectedRoute>
              <MainLayout><ClaimsManagement /></MainLayout>
            </ProtectedRoute>
          } />
